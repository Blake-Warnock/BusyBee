...
$sql = "select * from special inner join product on special.product_id = product.product_id";
            ...
            <div class="individual-product-container center"
                ...
                <div class="individual-product-container"
                    ...
                    <form name="<?php echo $productList[$x]["name"] . $x  ?>"
                       ...
                       <img class="product-img" src="<?php echo $productList[$x]["img_path"]?>.jpg" alt="<?php echo $productList[$x]["alt"] ?>">
                        <button class="product-btn" type="submit"><?php echo $productList[$x]["name"] ?><div
                                class="line"></div><?php echo $productList[$x]["size"] ?> Count
                                <div  class="line"></div>
                            Old Price $<?php echo $productList[$x]["price"] +1 ?>
                            <div class="line"></div>
                            New Price $<?php echo $productList[$x]["new_price"] ?>
