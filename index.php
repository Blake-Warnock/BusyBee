...
<div class="index-container">
    <section>
        <article>
                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/slide-one.png" alt="Granola Bar with the text granol bars 50 percent off wth code: buzy bee">
                        </div>

                        <div class="item">
                            <img src="images/slide-two.png" alt="Bananas, oranges, and strawberries with the text start a health life style">
                        </div>

                        <div class="item">
                            <img src="images/slide-three.png" alt="Honey stick dripping with honey and text that says bring health to the hive with our snackzzz">
                        </div>
                    </div>
            ...
            <div class="icon-bar">
                <div class="individual-icon"><img src="images/icons/green-freeship-icon.png" alt="Icon of shipping truck with the text free"><br>
                    <p>Free Shipping on Orders over $75</p>
                </div>
                <div class="individual-icon"><img src="images/icons/yellow-notest-icon.png" alt="Picture of a rabbit in an octagon with a line through it"><br>
                    <p>All non-GMO Products!</p>
                </div>
                <div class="individual-icon"><img src="images/icons/green-health-icon.png" alt="A picture of a leaf"><br>
                    <p>We Only Use Sustainable Packaging</p>
                </div>
                <div class="individual-icon"><img src="images/icons/yellow-honey-icon.png" alt="A pciture of a honey pot"><br>
        ...
        <article class="index-review">
            <div class="query-index">
                ...
                foreach ($reviewList as $r) {
                    //loops reviews
                ?>
                <div class="query-index-individual reviews">
