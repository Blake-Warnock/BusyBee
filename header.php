...
<body>
    <header>
        <img id="logo" src="images/logo.png" alt="Busy Bee Snacks Logo">
        <nav>
            <ul>
        ...
        <div id="mini-nav">
            <ul>
                ...
                <li><a href="account.php"><img src="images/icons/green-account-icon.png" alt=""></a></li>
                <li><a href="fav.php"><img src="images/icons/yellow-fave-icon.png" alt=""></a></li>
                <li><a href="cart.php"><img src="images/icons/green-cart-icon.png" alt="">
