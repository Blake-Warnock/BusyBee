...
<h1>Return Policy</h1>
<h2>General Terms</h2>
<p>All products sold by Busy Bee Snacks are brand new and are manufactured to meet the highest industry standards. All
    prices and
    specifications are subject to change without notice. Products are shipped F.O.B. (Freight On Board) and become the
    sole property of the purchaser upon delivery to the specified shipping agent. For shipping damage, customers should
    file claim to their carrier immediately. Any discrepancy, including wrong items or missing items, should be reported
    to Busy Bee Snacks within 24 hours. All packages will be shipped the following business day. Because of the nature
    of the
    Internet, online ordering your purchase from Busy Bee Snacks acknowledges that you have read and agree to these
    terms and
    conditions. All brands and product names mentioned are trademarks and/or registered trademarks of their respective
    holders.</p>
<h2>Busy Bee Snacks Return Merchandise Authorization (RMA) Policy</h2>
<ul>
    <li>
        <p>All order changes or cancellations should be reported prior to shipping and by phone on 1-555-555-5555. Email
            is not accepted.</p>
    </li>
    <li>
    ...
    <li>
        <p>All returned parts may be subject to quality, operation, and/or performance tests by Busy Bee Snacks testing
            facility or
            by a third party authorized by Busy Bee Snacks. Upon the explained test(s) results, nondefective generic
            items may be
            subject to a 15% restocking fee.</p>
    </li>
    <li>
        <p>Defective return does not include returns for incompatibility.</p>
    </li>
    <li>
        <p>Busy Bee Snacks reserves the right to replace defective parts or to issue a refund if Busy Bee Snacks sees
            more fit.</p>
    </li>
    <li>
        <p>All refunds after one week from the time item is received will be of the original value or the current market
    ...
    <li>
        <p>All products, unless otherwise stated, are covered by their respective manufacturer's warranties. Within
            thirty (30) days, we will repair or replace, at our sole discretion, any product that is deemed defective.
            After 30 days, the manufacturer's warranty process must be followed.</p>
    </li>
</ul>
<h2>What This Warrant Does Not Cover</h2>
<p>This warranty does not cover: installation or service of product; conditions resulting from consumer mishandling such
    as improper maintenance or misuse, abuse, accident, or alteration; all plastic surfaces and all other exposed parts
    that are scratched or damaged due to normal use; products which have had the serial number removed or made
    illegible; products rented to others. </p>
...
<ul>
    ...
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to Busy Bee Snacks.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Website</strong> refers to Busy Bee Snacks, accessible from <a href="busybeesnacks.com"
                rel="external nofollow noopener" target="_blank">busybeesnacks.com</a></p>
    </li>
    <li>
...
<ul>
    <li>By visiting this page on our website: <a href="http://busybeesnacks.com/contact.php"
            rel="external nofollow noopener" target="_blank">http://busybeesnacks.com/contact.php</a></li>
</ul>
<br>
